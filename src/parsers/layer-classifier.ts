...
const LAYER_PATTERNS = {
  [LayerType.Rules]: {
    ...
    contentPatterns: [
      /\b(never|must not|forbidden|prohibited|don't)\b/i,
      /\b(must|required|mandatory)\b/i,
  ...
  [LayerType.Tools]: {
    ...
    contentPatterns: [
      ...
      /\b(command|script|executable)\b/i,
      /\b(integration|plugin|extension)\b/i,
    ],
  },
  [LayerType.Methods]: {
    headingKeywords: [
